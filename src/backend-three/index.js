/**
 * Backend três. Esse servidor está consumindo informações do RabbitMQ, mais especificamente, da
 * fila número dois. A ideia é que ele tenha um comportamento diferente do backend dois em relação
